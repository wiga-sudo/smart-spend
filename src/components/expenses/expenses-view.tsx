...
export function ExpensesView() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `KshformData.type === "income" ? "Income" : "Expense"} of $KshMath.abs(amount).toFixed(2)} has been recorded.`
    })
  ...
  const handleDelete = (id: string, description: string) => {
    ...
    toast({
      ...
      description: `Kshdescription} has been removed.`
    })
  }
